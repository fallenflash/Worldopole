...
$req = "SELECT COUNT(DISTINCT(id)) AS total, 0 AS average_points FROM gym WHERE team_id = '1'";
$result = $mysqli->query($req);
$data = $result->fetch_object();
...
$req = "SELECT COUNT(DISTINCT(id)) AS total, 0 average_points FROM gym WHERE team_id = '2'";
$result = $mysqli->query($req);
$data = $result->fetch_object();
...
$req = "SELECT COUNT(DISTINCT(id)) AS total, 0 AS average_points FROM gym WHERE team_id = '3'";
$result = $mysqli->query($req);
$data = $result->fetch_object();
